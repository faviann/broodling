...
from evaluation.p5.v6 import setup_r01 as setup
from tests.support import durable_test_root, git


class P5V6SetupTests(unittest.TestCase):
    def setUp(self):
        self.root = durable_test_root("broodling-p5-v6-")
    ...
    def test_offline_preparation_is_idempotent_and_retains_no_credentials(self):
        ...
        retained = b"".join(before.values()) + (self.state / "setup-v6.json").read_bytes()
...
import evaluation.p5.v6.setup_r01
