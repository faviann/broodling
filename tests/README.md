...
| Explicit initialization and atomic upgrades | `StoreLifecycleTests`, authentic [.NET v1–v7 fixtures](Broodling.Tests/Fixtures/README.md): [state](../docs/implementation/dotnet-identity-custody.md) |
| Persisted installation pause, outstanding initiation evidence and drain ordering | `InstallationPauseTests`, `StoreLifecycleTests`: [installation pause](../docs/implementation/dotnet-installation-pause.md) |
