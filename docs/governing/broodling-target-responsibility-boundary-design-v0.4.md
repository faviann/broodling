...
> Read the [current architecture and P5 plan](current.md).
...
> [Exact pre-alignment file](https://github.com/faviann/broodling/blob/525902050c256f10232bd74ff717cfb59224e985/docs/governing/broodling-target-responsibility-boundary-design-v0.4.md) preserves the original complete bytes.
