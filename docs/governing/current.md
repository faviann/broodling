...
issue title and body, referenced comment bodies, other references' content,
starting commit and PR target, ignoring GitHub bookkeeping) equals that of an
already-admitted submission whose Contract has an Attempt, it ends with a
retained explanation linking that authority instead of being proposed or
executed. #205 runs `retire-attempt` and
