...
current schema 11 (historical H schema 7, schema-8 Issue submission persistence,
and schema-9 installation pause). Explicit upgrade recognizes unchanged v1–v10 definition hashes and
