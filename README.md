...
Issue #21 adds [irreversible abandonment, bounded physical cessation and owned retirement](docs/implementation/v1-p4-abandonment.md). Actual-provider controller-loss and durable-source containment controls pass, but the [temporary-source shared-Git counterexample](qualification/v1-p4/issue-21-provider-containment.md) leaves profile compatibility unresolved. #21 remains incomplete; #22–#24 have not begun. The [earlier cessation blocker](qualification/v1-p4/issue-21-cessation-boundary.md) is preserved. Replacement, Work Unit disposition and effects remain unimplemented.
