...
custody, supplied-source/GitHub Contract admission, original B1/Attempt allocation,
owned worktree materialization and frozen native dispatch, plus explicit store
lifecycle, status/history and submit/resume/wait commands. See the [.NET state guide](docs/implementation/dotnet-identity-custody.md)
...
[materialization](docs/implementation/dotnet-worktree-materialization.md) and
[native dispatch/submit/resume](docs/implementation/dotnet-native-dispatch.md), and
[receipt-backed completion by exact Attempt](docs/implementation/dotnet-receipt-completion.md).
