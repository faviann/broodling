...
from existing state. It has no #100 submission intake, bundled proposer,
pre-Contract capture lifecycle, automatic progression or automatic completion
capture. Scheduling, backlog selection, Compose deployment,
