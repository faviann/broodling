...
lifecycle, status/history and submit/resume commands. See the [.NET state guide](docs/implementation/dotnet-identity-custody.md)
...
[native dispatch/submit/resume](docs/implementation/dotnet-native-dispatch.md).
