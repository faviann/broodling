...
Documentation baseline established against the accepted v0.3 target. Product implementation and P1 qualification have not started; product language, framework, and storage remain deferred.
